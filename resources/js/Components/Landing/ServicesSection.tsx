                            ...
                            <button
                                ...
                                className={`relative flex items-center gap-2 rounded-full px-5 py-2.5 text-sm font-medium transition-all duration-300 ${
                                    activeTab === index
                                        ...
                                        : 'border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 text-gray-600 dark:text-white/60 hover:border-gray-300 dark:hover:border-white/20 hover:text-gray-900 dark:hover:text-white'
                                }`}
                            >
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                        {activeCategory.services.map((service, i) => (
                            ...
                            >
                                <div className="glass-card group h-full overflow-hidden transition-all duration-300 hover:scale-[1.02] hover:border-gray-300 dark:hover:border-white/15">
                                    {/* Service Image */}
                                    <div className="relative aspect-video overflow-hidden">
                                        ...
                                        {service.is_coming_soon && (
                                            <div className="absolute top-3 right-3 flex items-center gap-1 rounded-full bg-yellow-500/20 px-3 py-1 text-xs font-medium text-yellow-600 dark:text-yellow-300 backdrop-blur-sm">
                                    ...
                                    <div className="p-5">
                                        ...
                                        <div className="mt-4">
                                            {service.is_coming_soon ? (
                                                <span className="inline-flex items-center gap-1 text-sm text-yellow-600 dark:text-yellow-400/80">
