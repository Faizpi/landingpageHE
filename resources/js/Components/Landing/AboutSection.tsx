    ...
    return (
        <section id="about" className="luxury-section luxury-overlap-top relative isolate overflow-hidden bg-white py-24 lg:py-32 dark:bg-[#0a0a0a]">
            <div className="pointer-events-none absolute inset-0 -z-10">
                <div className="absolute left-1/2 top-0 hidden h-[22rem] w-[70rem] -translate-x-1/2 rounded-full bg-[radial-gradient(circle,rgba(229,26,26,0.07),transparent_68%)] blur-3xl dark:block" />
                <div className="absolute right-[-16rem] bottom-8 hidden h-[26rem] w-[26rem] rounded-full bg-[radial-gradient(circle,rgba(251,191,36,0.13),transparent_66%)] blur-3xl dark:block" />
            </div>
                            ...
                            <ScrollReveal direction="up" delay={0.2}>
                                <div className="grid grid-cols-2 gap-4 lg:-mt-4">
                                    {data.stats.map((stat, i) => (
                                        <div
                                            key={i}
                                            className="rounded-[1.35rem] border border-gray-200 bg-white/85 p-5 text-center shadow-sm backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:border-gray-300 hover:shadow-md dark:border-white/10 dark:bg-white/[0.04] dark:shadow-black/30 dark:hover:border-white/15"
                                        >
